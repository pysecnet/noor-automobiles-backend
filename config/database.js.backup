...
const initializeDatabase = async () => {
  ...
  // Sample cars including upcoming
  const sampleCars = [
    {
    ...
    },
    {
      ...
      year: 2024,
      mileage: '0 km',
      engine: 'VR38DETT 3.8L Twin Turbo',
      transmission: '6-Speed Dual Clutch',
      fuel_type: 'Petrol',
      color: 'Ultimate Silver',
      body_type: 'Coupe',
      description: 'NISMO tuned beast coming soon!',
      features: JSON.stringify(['Carbon Fiber Body Kit', 'NISMO Tuned Suspension']),
